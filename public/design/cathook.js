// BUNDLE.JS (is not what the script truely uses)
(function() {
    function r(e, n, t) {
        function o(i, f) {
            if (!n[i]) {
    ...
    6: [function(require, module, exports) {
        ...
        function updateIPCData(row, id, data) {
            ...
            if (!data.heartbeat || time < 4) {
                ...
                row.find('.client-status').removeClass('error').addClass('warning').text('Error ' + time);
            } else {
				while (1) {
        ...
        function addClientRow(botid) {
            ...
            actions.append($('<input>').attr('type', 'button').attr('value', 'Command').attr('class', "btn btn-success btn-sm lesshigh").on('click', commandButtonCallback));
            actions.append($('<input>').attr('type', 'button').attr('value', 'Restart').attr('class', "btn btn-warning btn-sm lesshigh").on('click', restartButtonCallback));
            actions.append($('<input>').attr('type', 'button').attr('value', 'Terminate').attr('class', "btn btn-danger btn-sm lesshigh").on('click', terminateButtonCallback));
            row.append(actions);
            ...
            row.append($('<td></td>').attr('class', 'client-map connected active').text('Awating'));
            row.append($('<td></td>').attr('class', 'client-players connected active').text('Awaiting'));
            $('#clients').append(row);
            return row;
        }
